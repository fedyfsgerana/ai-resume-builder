        ...
        <Transition name="fade">
            <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-[9998] px-4"
                ...
                <Transition name="scale">
                    <div v-if="isOpen" class="w-full max-w-sm p-6 bg-white rounded-2xl shadow-modal">
                        ...
                        <p class="mb-6 text-sm text-secondary-500">{{ message }}</p>
                        <div class="flex gap-3">
                            <button @click="handleCancel" class="flex-1 btn-secondary">
                                {{ cancelText }}
                            </button>

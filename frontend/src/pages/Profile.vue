    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-8">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-secondary-500">Kelola informasi akun kamu</p>
            </div>
        </div>
        ...
        <div class="mb-6 card">
            <div class="flex items-center gap-5">
                <div
                    class="flex items-center justify-center w-16 h-16 text-2xl font-bold rounded-full bg-primary-100 text-primary-700 shrink-0">
                    {{ userInitial }}
                </div>
                <div>
                    <p class="text-lg font-bold text-secondary-900">{{ user?.name }}</p>
        ...
        <div class="mb-6 card">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="font-semibold text-secondary-900">Informasi Profil</h2>
            </div>
            ...
            <form @submit.prevent="handleUpdateProfile" class="flex flex-col gap-4">
                ...
                <div>
                    <label class="block mb-1 text-sm font-medium text-secondary-700">Bergabung Sejak</label>
                    <div class="relative">
                        <Calendar class="absolute w-4 h-4 -translate-y-1/2 left-3 top-1/2 text-secondary-400" />
                        <input :value="formatDate(user?.createdAt)" type="text" class="pl-10 input bg-secondary-50"
                            disabled />
                    </div>
                </div>
        ...
        <div class="card">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="font-semibold text-secondary-900">Ganti Kata Sandi</h2>
            </div>

            <form @submit.prevent="handleUpdatePassword" class="flex flex-col gap-4">
                <div>
                    <label class="block mb-1 text-sm font-medium text-secondary-700">Kata Sandi Lama</label>
                    <div class="relative">
                ...
                <div>
                    <label class="block mb-1 text-sm font-medium text-secondary-700">Kata Sandi Baru</label>
                    <div class="relative">
                        <Lock class="absolute w-4 h-4 -translate-y-1/2 left-3 top-1/2 text-secondary-400" />
                ...
                <div>
                    <label class="block mb-1 text-sm font-medium text-secondary-700">Konfirmasi Kata Sandi Baru</label>
                    <div class="relative">
                        <Lock class="absolute w-4 h-4 -translate-y-1/2 left-3 top-1/2 text-secondary-400" />
...
import {
    ...
    Save, ShieldCheck, UserCircle, Calendar

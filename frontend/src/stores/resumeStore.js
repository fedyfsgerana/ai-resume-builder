...
export const useResumeStore = defineStore('resume', () => {
  ...
  const regenerateSection = async (id, section, index) => {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Failed to regenerate section'
      throw err
    } finally {
      generating.value = false
    }
  ...
  const fetchMatchScore = async (id) => {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Failed to fetch match score'
      throw err
    } finally {
      loading.value = false
    }
  ...
  const duplicate = async (id) => {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Gagal menduplikat CV'
      throw err
    } finally {
      loading.value = false
    }
